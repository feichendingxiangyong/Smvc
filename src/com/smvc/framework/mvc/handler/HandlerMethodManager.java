 ...
 * @comment 
 */
package com.smvc.framework.mvc.handler;
...
import com.smvc.framework.util.Assert;
import com.smvc.framework.util.PathUtil;
...
public class HandlerMethodManager {
     ...
     */
    private static Map<Class<?>, Map<Method, MappingInfo>> handlerMethodMapping = new HashMap<>();
    ...
    public void registHandlerMethod(Class<?> clazz)
    {
        ...
        // result
        Map<Method, MappingInfo> results = new HashMap<>();
