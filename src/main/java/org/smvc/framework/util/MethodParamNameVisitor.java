...
//        String[] s = getMethodParamNames2(MethodParamNameVisitor.class.getMethod(
//                "getMethodParamNames", Method.class));
//        System.out.println(Arrays.toString(s));
//
//        s = getMethodParamNames2(MethodParamNameVisitor.class.getDeclaredMethod("sameType",
//                Type[].class, Class[].class));
//        System.out.println(Arrays.toString(s));
//
//        s = getMethodParamNames2(MethodVisitor.class.getDeclaredMethod("visitAnnotation",
